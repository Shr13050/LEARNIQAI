...
//           <div className={cn("relative z-50", className)}>{children}</div>
//         </div> */}
//         <div style="transform: translate(-50%, -50%) rotateX(0deg) scale(1); width: 377px; height: 300px; margin-top: 144px;" class="absolute left-1/2 top-1/2 p-4 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"><div class="relative z-50"><span>Pin Content</span></div></div>
//       </div>
//       <PinPerspective title={title} href={href} />
//     </Link>
//   );
...
// }) => {
//   return (
//     <motion.div className="pointer-events-none w-[40rem] h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
//       <div className="w-full h-full -mt-7 flex-none inset-0">
//         <div className="absolute top-0 inset-x-0 flex justify-center">
//           {href && (
...
export const PinContainer = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ transform, width: "377px", height: "300px", marginTop: "144px" }}
          className="absolute left-1/2 top-1/2 p-4 flex justify-start items-start rounded-2xl shadow-[0_8px_16px_rgb(0_0_0/0.4)] bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
          <div className={cn("relative z-50", className)}>{children}</div>
        </div>
