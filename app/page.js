...
import { HoverBorderGradientDemo } from "@/components/hoverbuttonborder";
import { HeroHighlight } from "@/components/ui/hero-highlight";
import { InfiniteMovingCardsDemo } from "@/components/movingcards";
import { AppleCardsCarouselDemo } from "@/components/applecardcrousel";
import { ThreeDMarqueeDemoSecond } from "@/components/3dmarque";
...
export default function Home() {
  ...
  {/* <HeroHighlight /> */}
  {/* <p className=" inset-0 flex items-center justify-center text-4xl font-bold z-10 m-5">
  ...
  <details className="group rounded-lg bg-gray-50 p-6 [&_summary::-webkit-details-marker]:hidden" open>
    <summary className="flex cursor-pointer items-center justify-between gap-1.5 text-gray-900">
      ...
      <span className="relative size-5 shrink-0 shadow-sm">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute inset-0 size-5 opacity-100 shadow-sm group-open:opacity-0"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute inset-0 size-5 opacity-0 shadow-sm group-open:opacity-100"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth="2"
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        ...
        <div className="text-center sm:text-left">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              <a className=" text-white transition " href="#"> FAQs </a>
            </li>

            <li>
              <a className=" text-white transition " href="#"> Support </a>
            </li>
